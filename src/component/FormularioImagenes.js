...
export default function FormularioImagenes({perfilUser}) {
  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center items-center  h-64 bg-gray-50 rounded-lg border-2 border-gray-300 border-dashed cursor-pointer dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
        {previewURL && (
          <img
            src={previewURL}
            alt="preview"
      ...
      <label htmlFor="nombre" className="block  mx-auto text-sm font-medium text-gray-900  dark:text-gray-800">
        Nombre del archivo:
        <input type="text" name="nombre" id="nombre"className="bg-gray-50 inline-block border border-gray-300 text-gray-900 text-sm rounded  ml-3 w-1/2 p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white " />
      </label>
      ...
      >
        {loading ? (
          <>
           ...
           <span className="animate-pulse uppercase font-medium text-xs ">Subiendo...</span>
          </>
        ) : (
          "Subir imagen"
        )}
